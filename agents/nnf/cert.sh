...
# Retrieves the service token and certificate for accessing NNF resources
# from a running Kubernetes cluster with NNF deployed.

SERVICE_ACCOUNT=nnf-controller-manager
